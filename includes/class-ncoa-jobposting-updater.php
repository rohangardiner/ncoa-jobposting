...
if ( ! defined( 'ABSPATH' ) || class_exists( 'WPGitHubUpdaterNcoaJobposting' ) || class_exists( 'WP_GitHub_Updater_Ncoa_Jobposting' ) )
	return;
 ...
 * @package WP_GitHub_Updater_Ncoa_Jobposting
 ...
 */
class WP_GitHub_Updater_Ncoa_Jobposting {
